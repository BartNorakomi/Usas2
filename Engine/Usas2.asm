...
; block $1e - &1f
;
MapsBlock01:  equ   $1e / 2
phase	$8000
MapA01_001:   ;EngineType, graphics, palette,
  incbin "..\maps\A01-001.map.pck"  | .amountofobjects: db  14
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks13Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks14Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0 | dw PuzzleBlocks15Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
...
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks1Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks2Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0 | dw PuzzleBlocks3Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
...
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks19Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks20Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 0,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0|dw PuzzleBlocksEmpty| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
...
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks4Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks5Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0 | dw PuzzleBlocks6Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
...
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks21Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks22Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 0,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0|dw PuzzleBlocksEmpty| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
...
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks16Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks17Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0 | dw PuzzleBlocks18Y| db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
...
;Pushing Stones: v1=sx, v2=falling stone?, v3=y movement, v4=x movement, v7=set/store coord, v1-2= coordinates
       ;alive?,Sprite?,Movement Pattern,               y,      x,   ny,nx,Objectnr#                                    ,v1, v2, v3, v4, v5, v6, v7, v8, v9,Hit?,life,movepatbloc
.object1: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb1,0 db 0 | dw PuzzleBlocks7Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object2: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb2,0 db 0 | dw PuzzleBlocks8Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
.object3: db 1,        0|dw PushingStone        |db 8*00|dw 8*00|db 16,16|dw CleanOb3,0 db 0 | dw PuzzleBlocks9Y | db  112,+00,+00,+00,+00,+00,+00,+00,+00, 0|db 000,movepatblo1| ds fill-1
