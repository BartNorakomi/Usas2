...
#npx convertgfx --source ..\grapx\sourcefiles\GfxObjectsForVram.bmp  --slice.x 186 --slice.y 16 --slice.width 54 --slice.height 21 --fixedPalette "..\grapx\tilesheets\karnimata.tiles.pl" --targetScreen5 ..\grapx\129-hugeSpider.sc5.gfx
#npx convertgfx --source ..\grapx\sourcefiles\GfxObjectsForVram.bmp  --slice.x 112 --slice.y 16 --slice.width 74 --slice.height 32 --fixedPalette "..\grapx\tilesheets\karnimata.tiles.pl" --targetScreen5 ..\grapx\129-hugeSpider.sc5.gfx
